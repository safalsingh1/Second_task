...
class DatabaseSettings(BaseModel):
    ...
    service_url: str = Field(default_factory=lambda: os.getenv("TIMESCALE_SERVICE_URL", "postgresql://postgres:password@timescaledb:5432/postgres"))
...
class VectorStoreSettings(BaseModel):
    ...
    embedding_dimensions: int = 384  # Updated to 384 dimensions
